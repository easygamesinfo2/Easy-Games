        ...
        <form name="signup" method="post" class="ui large form">
            <div class="ui stacked segment">
                ...
                <div class="field">
                    ...
                    <div>
                        <button type="submit"  value="cadastrar" name="cadastrar" id="cadastrar" class="ui inverted fluid large submit button" style="background-color: #191919">Cadastrar</button>
                    </div>
            </div>
