...
<div class="ui form" style="margin-top: 5%">
        ...
        <div class="field grey">
            ...
            <h1 style="color: white;">Criar notícia</h1>
...
<button type="submit" name="inserir" value="inserir" class="ui  grey button" style="margin-top: 2%; background-color: white;color: black">Enviar</button>
